...
<h1 align="center">.NET API Boilerplate</h1>

<p align="center">
  A modern ASP.NET Core minimal API, ready to deploy on Light Cloud.
</p>
...
- ASP.NET Core minimal APIs on .NET 8
- CORS enabled
